...
from constants import OUTPUT_FILE_NAME, RECORD_SEC, SAMPLE_RATE, READ_FILE_NAME
...
def play_audio_file(file_name: str = READ_FILE_NAME) -> None:
    """
    Plays an audio file.

    Args:
        file_name (str): The name of the file to be played. Defaults to READ_FILE_NAME

    Returns:
        None
    """
    logger.debug("Playing back audio data")
